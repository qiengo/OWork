...
/**
 * 具有圆角功能的RoundedDrawable，取自第三方库
 * @author 王植桦 ewangzhihua@yeah.net
 * @version 创建时间：2014年3月29日
 *
 */
public class RoundedDrawable extends Drawable {
  ...
  private final Paint mBitmapPaint,mSelectorPaint;
  private final int mBitmapWidth;
  private final int mBitmapHeight;
  private final RectF mBorderRect = new RectF();
  private final Paint mBorderPaint;
  private final Matrix mShaderMatrix = new Matrix();
  private final int SelectorColor=0x44000000;
  ...
  public void draw(Canvas canvas) {
    ...
    if (mOval) {
      ...
      if (mBorderWidth > 0) {
        ...
        if(isPressed()){
        	canvas.drawRoundRect(mDrawableRect, mCornerRadius, mCornerRadius, mSelectorPaint);
        }
      }
    }
  }
